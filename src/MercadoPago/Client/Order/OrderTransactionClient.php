...
use MercadoPago\Client\Order\Transaction\UpdateTransaction;
...
final class OrderTransactionClient extends MercadoPagoClient
{
     ...
     * @throws \Exception if the request fails.
     */
    public function update(string $order_id, string $transaction_id, UpdateTransaction $request, ?RequestOptions $request_options = null): UpdateTransaction
    {
