...
[![Build Status](https://travis-ci.org/fcwwebsites/dx-php.png)](https://travis-ci.org/fcwwebsites/dx-php)
...
2. Go to your project directory and run `composer require "fcwwebsites/dx-php:1.9.0"` on the command line.
